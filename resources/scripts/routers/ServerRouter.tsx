                ...
                >
                    {!uuid || !id ? (
                        ...
                        <>
                            ...
                            <div tw="bg-neutral-700/95 border-b border-neutral-700 px-4 sm:px-6 py-3 flex flex-nowrap items-center sticky top-[3.5rem] z-30 shadow-md backdrop-blur-sm overflow-hidden">
