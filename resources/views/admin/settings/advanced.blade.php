                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-8">
                                ...
                                <div>
                                    <input type="password" class="form-control" name="pterodactyl:steam:api_key" autocomplete="new-password" placeholder="@if($steamApiKeyConfigured)•••••••• (configured)@else Enter your Steam Web API key @endif">
                                    <p class="text-muted small">
                                        Required to browse Steam Workshop content inside the client panel.
                                        Obtain a key at <a href="https://steamcommunity.com/dev/apikey" target="_blank" rel="noopener">steamcommunity.com/dev/apikey</a>.
                                        Leave blank to keep the existing key. Enter <code>!e</code> to remove it.
                                    </p>
                                </div>
                            </div>
                        </div>
