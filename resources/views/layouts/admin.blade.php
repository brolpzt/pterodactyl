...
<html>
    <head>
        ...
        <link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#2258ff">
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.workshop') ?: 'active' }}">
                            <a href="{{ route('admin.workshop') }}">
                                <i class="fa fa-puzzle-piece"></i> <span>Steam Workshop</span>
                            </a>
                        </li>
